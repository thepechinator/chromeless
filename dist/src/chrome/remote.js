                                                    ...
                                                    return __generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            case 0:
                                                                ...
                                                                if (data.outOfTime) {
                                                                    console.warn("Chromeless Proxy disconnected because it reached its execution time limit (15 seconds!).");
                                                                }
                            ...
                            _this.channel.subscribe(_this.TOPIC_RESPONSE, function () {
                                _this.channel.on('message', function (topic, buffer) {
                                    if (_this.TOPIC_RESPONSE === topic) {
                                        ...
                                        var status_1 = JSON.parse(buffer.toString());
                                        reject(status_1);
                                    }
                                });
